...
export const pictoryAiTutorial: PlatformTutorialData = {
  ...
  whatItIs: [
    "Pictory is a browser tool that turns writing you already have — a script, a blog post, a PDF, a slide deck — into a narrated video with captions and matching footage, without you ever opening a video editor.",
    "It does not film or draw anything original by default. Its main job is matching your sentences to ready-made clips from a large licensed library and reading your words in a synthetic voice. Pictory's help centre names Storyblocks and Getty Images as the sources of the visuals and Melodie as the source of the background music.",
    "It also works in the other direction: upload a webinar, a Zoom recording or a podcast episode and Pictory writes out everything said, so you can shorten the video by deleting sentences from the text rather than dragging on a timeline.",
    "A newer layer generates visuals from scratch — images, short AI video, and computer-generated presenters — rather than pulling them from the library. That layer is priced separately from everything else on the page, which is worth understanding before you lean on it.",
  ],
  ...
  security: [
    ...
    },
    {
      ...
      items: [
        ...
        "Unreleased product material, where a leak is the whole risk",
        "Recordings containing other people's faces and voices who have not agreed to a vendor processing them",
      ],
    },
    {
      kind: "text",
  ...
  triad: {
    bestAt: [
      "Turning something already written into a watchable video — a blog post, a script, a PDF, a slide deck",
      "Shortening a long recording by deleting sentences from its written-out version",
    ...
    okayAt: [
      "Clip choice. It matches on keywords, so a concrete sentence gets a usable shot and an abstract one gets a generic office corridor you will want to swap",
      "Voice performance. The standard voices read cleanly but flatly; the ones that sound genuinely human come out of the separately capped premium pool",
    ...
    avoid: [
      ...
      "Expecting the footage to be about you. The library is stock, so a video about your product shows somebody else's product unless you upload your own material — which is a different, slower workflow from the one Pictory is fast at.",
    ],
  },
  ...
  starterActions: [
    {
      ...
      whyHere: `Pictory chooses footage sentence by sentence on keywords, so a script that mixes concrete nouns with abstractions shows you both outcomes in one pass — the bank-account lines get usable shots, "order of operations" gets a stock boardroom. invideo AI now starts from footage you upload and an edit you describe, so it never makes this guess; the guess is Pictory's, and it is cheaper to learn on a throwaway script than on a deadline.`,
      tweak:
    ...
    },
    {
      ...
      whyHere:
        "Descript does transcript-based cutting too, and does it on a permanent free plan capped at 60 minutes of media a month. What Pictory adds on the same file is offering to pick the summary sentences for you and rebuild the recording as a short — Descript leaves every choice to you. Running one file through both is the fastest way to find out which of those you actually want.",
    },
    {
      ...
      whyHere:
        "Pictory's help centre says video minutes are deducted only on the first download of a project and that later downloads of the same project do not touch the quota. That makes finishing inside one project meaningfully cheaper than starting a fresh one each time you change your mind — a habit worth forming in week one. invideo AI bills a monthly credit pot that its own pricing page says does not roll over, so the same habit buys you nothing there.",
    },
    {
      ...
      whyHere:
        "Pictory publishes a per-model, per-second price for this — its credits article currently puts generated video somewhere between about 1.6 and 20 credits a second depending which model you choose, and a presenter at around 15 credits per 30 seconds. One deliberate shot converts your monthly credit number into something you can picture. Descript meters AI credits per plan too, but against editing features rather than a published per-second rate for generated footage, so there is no equivalent meter to calibrate there.",
      tweak:
    ...
    },
    {
      ...
      whatItDoes:
        "Before writing anything long, open the voice picker and check whether the language you need is one of the seven standard-voice languages or only in the 29-language premium set.",
      whyHere:
        "Pictory meters the two pools differently — standard voices are unlimited on a paid plan but cover only seven languages, while the premium voices come out of a capped monthly minute allowance, currently around 60 minutes on Starter. On this tool the language you write in quietly decides whether narration is effectively free or rationed. Descript publishes one flat transcription-language list per plan, currently 25 languages including on its free tier, with no second pool to run out of.",
    },
  ],

  pitfalls: [
    `The first pass's clip choices are the weakest thing about the output. Pictory matches footage to keywords, so "our team has grown" reliably returns a stranger's open-plan office. Budget time to swap shots; publishing pass one is how Pictory videos come to look like Pictory videos.`,
    "The trial clock runs on days, not on use. Fourteen days pass whether or not you make anything, so start it on a day you already have a script ready rather than on the day you first hear about the tool.",
    ...
    "Any single video is capped at 30 minutes on the paid plans, so a two-hour webinar cannot come out whole. It has to be cut down or split first — which is exactly what the transcript editor is for, but it is a step people do not expect.",
  ],
