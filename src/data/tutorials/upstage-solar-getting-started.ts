...
export const upstageSolarTutorial: PlatformTutorialData = {
  ...
  security: [
    {
      kind: "text",
      text: "Every document you send leaves your machine and is processed on Upstage's infrastructure, which its privacy policy says runs on US cloud providers. What happens to it next depends on which tier you are on — but check the date on the terms before you rely on any of this. **The version that draws the line sharply does not bind anyone yet.** Upstage's terms of service take a new version on 21 September 2026, and that version's Article 22 says that for paid services Upstage will not use your inputs or outputs for service improvement or model training without separate consent, while for free services the data may be used for service improvement and for AI research and development, training included; it also tells free-service users not to input personal data at all. What governs a reader today is the version before it, which Upstage dates 1 July to 20 September 2026, and we could not retrieve its text from Upstage's public pages to confirm whether it splits free from paid the same way. Assume the free tier may be trained on until you have read the version in force on the day you sign up.",
    },
    {
      kind: "list",
