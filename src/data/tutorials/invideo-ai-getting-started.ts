...
export const invideoAiTutorial: PlatformTutorialData = {
  ...
  whatItIs: [
    ...
    "It writes the script as well, and the footage and music come from licensed stock libraries — iStock, Storyblocks and Shutterstock — though it can also generate shots outright.",
    `During 2026 invideo repositioned itself around "Agent Two", marketed as an agentic video editor for serious creatives, with project memory that carries characters and tone between sessions. The simple on-ramp — describe a video, get a cut — is still there and is still the right way in.`,
  ],
  ...
  security: [
    {
      kind: "text",
      text: `Unlike most video tools, invideo is explicit about training. Its privacy policy (effective 8 June 2026, last updated 8 July 2026) states flatly, "We do not use your User Content, Inputs, Output or Designs to train or fine-tune our proprietary artificial intelligence or machine-learning models."`,
    },
    {
      kind: "list",
    ...
    {
      kind: "text",
      text: "Delete your account and invideo says content leaves active systems within about 90 days, with backups overwritten on normal rotation. Ordinary marketing footage is fine here; unreleased client material run through a model whose tier you have not checked is the case worth a second thought.",
    },
  ],

  triad: {
    bestAt: [
      "Turning a written idea, or a script you already have, into a complete first cut — subtitles included",
  ...
  starterActions: [
    {
      ...
      whyHere:
        "The prompt page runs Agent mode by default and takes a one-line concept, a loose treatment or a finished script in the same field.",
    ...
    },
    {
      ...
      whyHere:
        "iStock is the one capped library, and invideo documents a `settings:` directive inside the prompt that caps or removes it; anything removed is replaced automatically from its Storyblocks and Shutterstock libraries, which are uncapped.",
    ...
    },
    {
      ...
      whyHere:
        "Magic Box sits under the rendered video rather than in a project panel, and it accepts media, audio, text and tone commands in the same sentence — including scene numbers.",
    ...
    },
    {
      ...
      whyHere:
        "Brazilian Portuguese is one of the 11 fully tested languages, and the language request goes in the prompt itself, so translation is a re-run of the same job rather than a separate export-and-dub pipeline.",
      tweak: "Check the subtitle list above first — several supported languages do not yet get subtitles.",
    },
    {
      ...
      whyHere:
        "The credit cost is shown before the generation runs rather than billed after it, and the per-model gap is wide enough to change which model you pick.",
    },
  ],
  ...
  pitfalls: [
    ...
    `Every "try again" spends credits; exporting does not. The expensive habit is regenerating, not downloading.`,
