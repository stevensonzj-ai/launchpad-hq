...
export const mailchimpAiTutorial: PlatformTutorialData = {
  ...
  beforeYouStart: [
    ...
    "**The AI is not on the free plan.** Mailchimp's own plan comparison lists generative AI features as not included on Free. Creative Assistant starts at Essentials; Write with AI, Send Time Optimization, Content Optimizer, Analytics AI and the ChatGPT and Claude connectors start at Standard. Paid marketing plans currently begin around $13 a month at the smallest contact tier in US pricing, and the price is driven by how many contacts you hold rather than how many emails you send.",
  ...
  starterActions: [
    {
      ...
      whyHere:
        "Mailchimp says the subject line helper is free with every account, which makes it the only recipe on this page a free-plan reader can actually run today.",
      tweak:
