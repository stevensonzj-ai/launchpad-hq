...
export const microsoftPowerAutomateTutorial: PlatformTutorialData = {
  ...
  whatItIs: [
    ...
    "It is strongest on Microsoft's own apps and reaches everything else through **connectors** — Microsoft's ready-made links to other services, published as a catalogue that currently runs to well over a thousand entries. For the programs that have no connector at all, a separate Windows-only companion app drives ordinary desktop software by recording and replaying what you click.",
  ],
  ...
  beforeYouStart: [
    ...
    "The desktop recorder is a separate download and a separate world. Microsoft's requirements page lists Windows 10, Windows 11 and Windows Server 2016-2025, rules out machines with ARM processors, and offers no macOS or Linux version. On Windows Home editions you can build and run recordings on your own machine but cannot trigger them from the cloud, and work or school accounts need a Dataverse database provisioned in their default environment before desktop flows can be created at all — an administrator's job, not yours, and worth asking about before you install anything.",
  ],

  security: [
    {
      kind: "text",
      text: "Most automation tools answer only to you. Power Automate answers to your employer as well: a flow you build on a work account lives inside your organisation's Microsoft account, alongside its Outlook and Teams, where IT administrators can see it and set the rules it runs under. Build accordingly.",
    },
    {
      kind: "list",
  ...
  triad: {
    ...
    okayAt: [
      "Anything outside Microsoft's own apps. The connectors exist, but the ones people ask for first are classed premium.",
  ...
  starterActions: [
    {
      ...
      whyHere:
        "Outlook, OneDrive for Business and SharePoint are all standard connectors, so this flow runs on the Microsoft 365 licence your employer already pays for. Put Zapier in that sentence and it stops being true: there the same three steps are metered against a plan you buy on top.",
      tweak:
        "The box on the Power Automate home page will draft this from a sentence you type — \"when I get an email with an attachment, save it to OneDrive\" — on an ordinary Microsoft 365 licence, and if the box isn't there it is usually the generative-AI region switch above.",
    },
    {
      ...
      whyHere:
        "Forms, Excel Online (Business) and Teams normally authorise off the same work identity you are already signed in with, so there is usually nothing to connect before you start building. On Zapier each of the three is its own app connection you grant, name and later have to remember to revoke.",
    },
    {
      ...
      whyHere:
        "The Power Automate rights inside Microsoft 365 are metered daily rather than as a monthly bundle, so a weekly digest costs you nothing you would ever notice. On Zapier's free plan the same job draws down a monthly task allowance you also want for everything else you build that month.",
    },
    {
