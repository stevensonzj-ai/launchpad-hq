  ...
  return (
    <div className="min-h-screen bg-gray-950">
      ...
      <section className="relative overflow-hidden px-4 pb-24 pt-20 text-center">
        ...
        <div className="relative mx-auto max-w-4xl">
          ...
          <h1 className="text-5xl font-bold tracking-tight text-white sm:text-6xl lg:text-7xl">
            Launch your <span className="bg-gradient-to-r from-orange-400 to-yellow-300 bg-clip-text text-transparent">AI journey</span> with confidence
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-xl text-gray-400">
            168+ vetted AI tools across 15 categories. Find the perfect platforms
            for your goals, budget, and skill level &mdash; in minutes, not months.
          </p>
          ...
          <div className="mt-12 flex flex-wrap items-center justify-center gap-6 text-sm text-gray-500">
            <span className="flex items-center gap-1.5"><Star className="h-4 w-4 text-yellow-500" /> 168 vetted platforms</span>
            <span className="flex items-center gap-1.5"><Shield className="h-4 w-4 text-blue-400" /> Free tier analysis</span>
            <span className="flex items-center gap-1.5"><Zap className="h-4 w-4 text-green-400" /> Updated weekly</span>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-5xl px-4 pb-20">
        <h2 className="mb-2 text-center text-sm font-semibold uppercase tracking-widest text-orange-400">How it works</h2>
        <p className="mb-12 text-center text-2xl font-bold text-white">Three steps to your perfect AI stack</p>
        <div className="grid gap-8 md:grid-cols-3">
          <div className="rounded-xl border border-gray-800 bg-gray-900/50 p-6 transition-colors hover:border-orange-500/30">
            ...
            <p className="text-sm text-gray-400">
              Browse tools by category, price, difficulty, and privacy level.
              Every platform vetted across 28 data points.
            </p>
          </div>
          <div className="rounded-xl border border-gray-800 bg-gray-900/50 p-6 transition-colors hover:border-orange-500/30">
            ...
            <p className="text-sm text-gray-400">
              Take a 2-minute survey. Our engine matches you with the
              best tools for your goals, budget, and experience level.
            </p>
          </div>
          <div className="rounded-xl border border-gray-800 bg-gray-900/50 p-6 transition-colors hover:border-orange-500/30">
            ...
            <p className="text-sm text-gray-400">
              Follow step-by-step tutorials. Track your progress. Build
